...
userQueue.process(async (job, done) => {
  ...
  try {
    const mailSubject = 'Welcome to Alx ';
    const mailContent = [
      '<div>',
      '<h3>Hello {{user.name}},</h3>',
      'Welcome to <a href="https://github.com/MoodyEG/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'a simple file management API built with Node.js by ',
      '<a href="https://github.com/MoodyEG"></a>. ',
      'We hope it meets your Request.',
      '</div>',
    ].join('');
